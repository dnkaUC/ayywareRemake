...
public:
	...
	//void tes222t()
	//{
		//GetClientClass()->m_ClassID == (int)CSGOClassID::CBasePlayer;
	...
	{
		using SetAbsAechseFn = void(__thiscall*)(void*, const Vector &aechse);
		static SetAbsAechseFn SetAbsAechse;

		if (!SetAbsAechse)  // (Utilities::Memory::FindPattern("client.dll", (PBYTE)"\x55\x8B\xEC\x83\xE4\xF8\x83\xEC\x64\x53\x56\x57\x8B\xF1\xE8", "xxxxxxxxxxxxxxx"));
			SetAbsAechse = (SetAbsAechseFn)(Utilities::Memory::FindPattern("client.dll", (PBYTE)"\x55\x8B\xEC\x83\xE4\xF8\x83\xEC\x64\x53\x56\x57\x8B\xF1\xE8", "xxxxxxxxxxxxxxx"));
